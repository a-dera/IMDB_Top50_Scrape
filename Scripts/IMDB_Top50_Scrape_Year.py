...
opener.addheaders = [('User-agent', 'Mozilla/5.0')] # go to "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/User-Agent/Firefox" to adapte headers to your device.  
